          ...
          >
            <div>
              <div className="flex items-center gap-3">
                <img src={game.home_team.logo} className="h-8" />
                <p className="font-semibold">{game.home_team.name}</p>
              </div>
              <div className="flex items-center gap-3 mt-2">
                <img src={game.away_team.logo} className="h-8" />
            ...
            <div className="text-right">
              ...
              {game.thumbnail && (
                <img src={game.thumbnail} className="w-28 rounded mt-2" />
              )}
            </div>
          </div>
        ))}
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {upcoming.map(game => (
          ...
          >
            ...
            <div className="text-right">
              <p className="text-gray-700 text-sm font-medium">Hari ini</p>
